...
export default function BookUpdateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setAuthorFirst(cleanValues.authorFirst);
    setAuthorLast(cleanValues.authorLast);
    setPublisher(cleanValues.publisher);
    setIsbn(cleanValues.isbn);
    setPubDate(cleanValues.pubDate);
    setNumOfPages(cleanValues.numOfPages);
    setSynopsis(cleanValues.synopsis);
    setCover(cleanValues.cover);
    setCollectorInfo(cleanValues.collectorInfo);
    setEdition(cleanValues.edition);
    setPrinting(cleanValues.printing);
    setDustJacket(cleanValues.dustJacket);
    setCondition(cleanValues.condition);
    setDamage(cleanValues.damage);
    setAcquisitionDate(cleanValues.acquisitionDate);
    setAcquiredFrom(cleanValues.acquiredFrom);
    setAcquiredCost(cleanValues.acquiredCost);
    setErrors({});
  };
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        let modelFields = {
          ...
          dustJacket: dustJacket ?? null,
          condition: condition ?? null,
          damage: damage ?? null,
          acquisitionDate: acquisitionDate ?? null,
          acquiredFrom: acquiredFrom ?? null,
          acquiredCost: acquiredCost ?? null,
        };
